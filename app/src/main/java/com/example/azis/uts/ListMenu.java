...
import com.example.azis.uts.adapter.Product;
import com.example.azis.uts.adapter.ProductListAdapter;
import com.example.azis.uts.utils.SharedPreference;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by azis on 27/10/16.
 */
public class ListMenu extends AppCompatActivity{
    ...
    private void setProducts() {
        ...
        Product product2 = new Product(2, "Nasi Liwet",
                "Nasi liwet enak pisan asli", 50000);
